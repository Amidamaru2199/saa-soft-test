...
<template>
	<div class="account-row">
		<div class="account-field">
			<el-input v-model="formData.labelsInput" placeholder="Метка" maxlength="50" show-word-limit
				@blur="handleLabelsBlur" />
		</div>

		<div class="account-field">
			<el-select v-model="formData.recordType" placeholder="Выберите тип" @change="handleRecordTypeChange">
		...
		<div class="account-field">
			<el-input v-model="formData.login" placeholder="Логин" maxlength="100" :class="{ 'is-error': errors.login }"
		...
		<div class="account-field password-field">
			<el-input v-if="showPassword" v-model="formData.password" type="password" placeholder="Пароль"
				maxlength="100" show-password :class="{ 'is-error': errors.password }" @blur="handlePasswordBlur">
